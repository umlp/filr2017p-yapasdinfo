...
|2|métier|Alerter l'utilisateur en cas de notification sur l'application|Être mis au courant des événements sur son compte INSA dès qu’ils sont annoncés|MOA|Si il y a un changement sur l’application, l’utilisateur est alerté par une notification sur son téléphone|4|4|12| |
...
|6|exigence système|Accès à l'application hors ligne|Accéder notamment à l’agenda sans avoir besoins de se connecter à la page web|MOA|Si le téléphone de l’utilisateur n’a pas accès à internet, l’utilisateur doit avoir accès à la dernière mise-à-jour de l’application|5|2|||
...
|9|métier|Accès actualité RU/cafet/AS/evenements INSA|Être au courant des événements et actualités du campus|MOA|Partie de l’application réservé aux posts événementiels|4|3|||
